...
#ifndef FT_INCLUDE_FT_UTILS_REDIS_TRADER_CMD_HELPER_H_
#define FT_INCLUDE_FT_UTILS_REDIS_TRADER_CMD_HELPER_H_
...
#endif  // FT_INCLUDE_FT_UTILS_REDIS_TRADER_CMD_HELPER_H_
