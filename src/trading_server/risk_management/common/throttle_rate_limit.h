...
#ifndef FT_SRC_TRADING_SERVER_RISK_MANAGEMENT_COMMON_THROTTLE_RATE_LIMIT_H_
#define FT_SRC_TRADING_SERVER_RISK_MANAGEMENT_COMMON_THROTTLE_RATE_LIMIT_H_
...
#endif  // FT_SRC_TRADING_SERVER_RISK_MANAGEMENT_COMMON_THROTTLE_RATE_LIMIT_H_
