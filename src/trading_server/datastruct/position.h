...
#ifndef FT_SRC_TRADING_SERVER_DATASTRUCT_POSITION_H_
#define FT_SRC_TRADING_SERVER_DATASTRUCT_POSITION_H_
...
#endif  // FT_SRC_TRADING_SERVER_DATASTRUCT_POSITION_H_
