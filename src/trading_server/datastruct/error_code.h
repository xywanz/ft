...
#ifndef FT_SRC_TRADING_SERVER_DATASTRUCT_ERROR_CODE_H_
#define FT_SRC_TRADING_SERVER_DATASTRUCT_ERROR_CODE_H_
...
#endif  // FT_SRC_TRADING_SERVER_DATASTRUCT_ERROR_CODE_H_
